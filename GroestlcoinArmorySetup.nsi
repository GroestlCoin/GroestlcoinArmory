...
Name "Groestlcoin Armory"

# General Symbol Definitions
!define REGKEY "SOFTWARE\$(^Name)"
!define COMPANY "GroestlCoin"
!define URL http://groestlcoin.org/

# MultiUser Symbol Definitions
!define MULTIUSER_EXECUTIONLEVEL Highest
!define MULTIUSER_INSTALLMODE_COMMANDLINE
!define MULTIUSER_INSTALLMODE_INSTDIR GroestlcoinArmory
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER GroestlcoinArmory
...
InstallDir "$PROGRAMFILES\GroestlcoinArmory"
CRCCheck on
XPStyle on
...
VIAddVersionKey ProductName "GroestlCoin Armory"
...
Section -Main SEC0000
    ...
    ${If} ${RunningX64}
        ...
        RmDir /r $INSTDIR
        SetOverwrite on
        File /r GroestlcoinArmoryStandalone\*
        File GroestlcoinArmoryStandalone\Groestlcoin-ArmoryQt.exe
...
Section /o -un.Main UNSEC0000
    !insertmacro DELETE_SMGROUP_SHORTCUT "GroestlCoin Armory (testnet)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "GroestlCoin Armory (Offline)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "GroestlCoin Armory"
    Delete /REBOOTOK "$DESKTOP\GroestlCoin Armory.lnk"
    DeleteRegKey /IfEmpty HKEY_CURRENT_USER "Software\GroestlcoinArmory"
